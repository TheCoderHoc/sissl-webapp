...
export const CompanyInformationFormSchema = z.object({
    company_name: z.string().min(2, "Please enter company name"),
    reg_number: z.string().min(1, "Please enter registration number"),
    establishment_date: z.string().min(1, "Please select establishment date"),
    company_address: z.string().min(1, "Please enter company address"),
});
...
export const UploadDocumentSchema = z.object({
  cac_certificate: z
    .string()
    .url("CAC certificate must be a valid URL")
    .nonempty("CAC certificate is required"),

  proof_of_address: z
    .string()
    .url("Proof of address must be a valid URL")
    .nonempty("Proof of address is required"),
