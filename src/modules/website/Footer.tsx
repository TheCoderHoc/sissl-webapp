                ...
                <div className="bg-[#f2f2f2] dark:bg-[#181818] w-full max-w-[1200px] min-h-[350px] relative rounded-3xl">
                    ...
                    <div className="absolute top-10 md:top-20 left-4 md:left-16">
                        ...
                        <a
                            ...
                            className="inline-block  mt-6 md:mt-8 rounded-[8px] bg-si_yellow px-6 py-3 text-black font-medium hover:bg-yellow-300 transition"
                        >
                            Get Started
                        </a>
                    </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                        <li>
                            <a href="solution/staff-validation">
                                Staff Validation
                            </a>
                        </li>
                        <li>
                ...
                <div className="lg:col-span-2">
                    ...
                    <div className="flex flex-col sm:flex-col gap-4 mt-14">
                        ...
                        />
                        <a className="bg-si_yellow text-black px-6 py-2 rounded-md font-medium text-sm hover:bg-yellow-300 transition w-36">
                            Submit
                        </a>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-start lg:items-center">
                    ...
                    <button className="bg-si_yellow text-black px-6 py-2 rounded-md font-medium text-sm hover:bg-yellow-300 transition w-36 mt-20">
                        Contact sales
                    </button>
                </div>
            </div>
