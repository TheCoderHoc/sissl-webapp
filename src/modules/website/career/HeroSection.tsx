        ...
        <div className="container mx-auto flex px-5 pb-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 text-sm leading-relaxed text-gray-700 dark:text-white">
              Join a passionate team building trusted tools for access,
              <br className="hidden text-sm lg:inline-block" /> identity, and
              safety. At SISSL, your work directly impacts
              <br className="hidden text-sm lg:inline-block" /> how
              organizations host, verify, and protect.
            </p>
