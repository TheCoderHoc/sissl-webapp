  ...
  <section className="bg-white dark:bg-black flex items-center justify-center">
    <div className="w-full max-w-2xl px-6 py-24">
      ...
      <div className="space-y-6">
        {/* Email Field */}
        <div>
          <label htmlFor="email" className="block text-sm text-black dark:text-white mb-1">
            Email address
          </label>
          <input
            type="email"
        ...
        {/* Description Field */}
        <div>
          <label htmlFor="message" className="block text-sm text-black dark:text-white mb-1">
            Description
          </label>
          <textarea
            id="message"
        ...
        <div className="pt-4 text-center">
          <button
            type="submit"
            className="bg-si_yellow text-black font-medium px-6 py-3 rounded-md hover:bg-yellow-300 transition"
          >
            Submit request
          </button>
        </div>
