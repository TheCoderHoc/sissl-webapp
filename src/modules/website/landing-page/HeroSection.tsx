...
const HeroSection = () => {
    return (
        <section className="flex flex-col xl:flex-row xl:justify-between w-[80%] my-0 mx-auto  text-gray-600 body-font dark:bg-black pt-0">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div className="flex justify-center">
                        <a
                            ...
                            className="inline-flex text-base bg-primary border-0 py-2 px-6 focus:outline-none rounded "
                        >
                            Create Account
                        </a>
                    </div>
