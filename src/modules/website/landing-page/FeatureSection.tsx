...
import React from "react";
import FeatureCard from "./FeatureCard";
import { FeatureOne, FeatureTwo, FeatureThree } from "@/public/icons";

const FeatureSection = () => {
  const imageStyle =
    "absolute left-1/2 top-1/2 w-[173px] h-[199px] -translate-x-1/2 -translate-y-1/2 z-0 opacity-5";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-2xl sm:text-3xl font-medium text-white">
            Everything You Need to{" "}
            <span className="text-[#FFE500]">Host</span>,{" "}
            <span className="text-[#FFE500]">Validate</span>, and{" "}
            <span className="text-[#FFE500]">Secure</span>
          </h2>
        </div>
