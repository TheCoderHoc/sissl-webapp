...
export default function UploadSelfieForm() {
  ...
  const handleSubmit = () => {
    ...
    // You could call a POST request here or navigate
  };

  return (
    <div className="space-y-10">
      <div>
        <p className="text-sm mb-2">Upload Selfie</p>
        <UploadArea
          name="selfieUpload"
          onChange={(e) => updateField("selfieUpload", e.target.files)}
        />
      </div>
