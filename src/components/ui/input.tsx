        ...
        <div className={cn("relative w-full", icon && "flex items-center")}>
            ...
            <input
                ...
                className={cn(
                    ...
                    "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive h-12 text-foreground",
                    className,
                    icon && "pl-10",
                    type === "password" && "pr-10"
                )}
            ...
            {type === "password" && (
                ...
                >
                    {showPassword ? (
                        <EyeOff size={19} className="text-foreground" />
                    ) : (
                        <Eye size={19} className="text-foreground" />
                    )}
                </Button>
            )}
        </div>
