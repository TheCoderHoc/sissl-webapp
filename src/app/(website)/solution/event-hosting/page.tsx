        ...
        <div className="w-full xl:w-[40%] flex flex-col justify-center">
          ...
          <div className="flex xl:justify-between w-full lg:w-[75%]">
            <a
              ...
              className="flex items-center justify-center text-[14px] xl:text-[16px] w-[151px] h-[48px] xl:w-[181px] xl:h-[48px] mr-4 rounded-[8px] bg-primary text-black"
            >
              Get Started
            </a>
      ...
      <section className="flex flex-col justify-between w-[80%] my-8 xl:my-0 mx-auto py-26">
        <div className="imGroup">
          <div className="order-2 xl:order-1 w-full xl:w-[35%] flex flex-col justify-center">
            ...
            <p className="text-[14px]">
              Create an event in minutes by filling out only the essentials.
              Whether it’s a team sync or a major launch, you&apos;re up and
              running fast
            </p>
          </div>
          <Image
        ...
        <div className="imGroup">
          <div className="w-full xl:w-[35%] flex flex-col justify-center order-2">
            ...
            <p className="text-[14px]">
              Choose to offer free or paid tickets, set quantity limits, and
              customize pricing tiers — all only if the event calls for it.
            </p>
          </div>
          <Image
            className="order-1"
        ...
        <div className="imGroup">
          <div className="order-2 xl:order-1 w-full xl:w-[35%] flex flex-col justify-center">
            ...
            <p className="text-[14px]">
              Make your event private, public, or invite-only. Add password
              protection, unique entry links, or ID verification to secure
              access
            </p>
          </div>
          <Image
