    ...
    <div className="bg-white dark:bg-black pt-6 lg:pt-36 text-black dark:text-white transition-colors duration-300">
      <section className="flex flex-col xl:flex-row xl:justify-between w-[80%] mx-auto">
        <div className="w-full xl:w-[40%] flex flex-col justify-center">
          ...
          <p className="text-[14px] xl:text-[22px] py-[15px] xl:py-[40px]">
            Invite, verify, and manage attendees from one smart dashboard.
            Whether it’s a closed-door board meeting or a public seminar, SISSL
            ensures secure and organized access.
          </p>
          <div className="flex xl:justify-between w-full lg:w-[75%]">
            <a
              href="/auth/account-type"
              className="flex justify-center items-center text-[14px] xl:text-[16px] w-[151px] h-[48px] xl:w-[181px] rounded-[8px] bg-primary text-black mr-4"
            >
              Get Started
            </a>
      ...
      <section className="flex flex-col justify-between w-[80%] my-8 xl:my-0 mx-auto py-26">
        <div className="top text-[28px] lg:text-[40px] text-center mx-auto mb-[120px]">
          Smart Access from <br /> <span className="yText">Start</span> to{" "}
        ...
        <div className="imGroup">
          <div className="order-2 xl:order-1 w-full xl:w-[35%] flex flex-col">
            ...
            <p className="text-[14px]">
              Kick off by setting up your event details—name, date, location,
              and event type. Whether it’s a private internal meeting or a large
              public gathering, you’re in control.
            </p>
          </div>
          <Image
        ...
        <div className="imGroup">
          <div className="w-full xl:w-[35%] flex flex-col order-2">
            ...
            <p className="text-[14px]">
              Decide who gets in and how. Set access levels for different guest
              types—VIPs, staff, or general attendees. Choose whether guests can
              enter with a QR code, physical badge, or face match.
            </p>
          </div>
          <Image
            className="order-1"
        ...
        <div className="imGroup">
          <div className="order-2 xl:order-1 w-full xl:w-[35%] flex flex-col">
            ...
            <p className="text-[14px]">
              Send out personalized invites in just a few clicks—via email, SMS,
              or a secure link. Include event details, access credentials, and
              everything your guests need to show up prepared. Whether it’s one
              guest or a thousand, SISSL makes distribution simple and
              professional.
            </p>
          </div>
          <Image
