            ...
            <section className="flex flex-col xl:flex-row xl:justify-between w-[80%] my-0 mx-auto">
                <div className="w-[100%] xl:w-[40%] flex flex-col justify-center">
                    ...
                    <p className="dark:text-[#F9FAFB] text-black text-[14px] xl:text-[22px] py-[15px] xl:py-[40px]">
                        SISSL makes it easy for companies to validate new or
                        existing staff—whether they’re permanent, contract, or
                        temporary. Automate verification, reduce risk, and
                        ensure only the right people gain access
                    </p>
                    <div className="flex xl:justify-between w-[100%] lg:w-[75%]">
                        <a
                            href="auth/account-type"
                            className="flex justify-center items-center text-[14px] xl:text-[16px] w-[151px] h-[48px] xl:w-[181px] xl:h-[48px] mr-4 rounded-[8px] bg-si_yellow text-black"
                        >
                            Validate Staff
                        </a>
