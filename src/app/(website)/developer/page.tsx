        ...
        <div className="w-full md:w-1/2">
          <div className="w-full max-w-md">
            ...
            <p className="text-sm md:text-base dark:text-gray-300">
              Use SISSL’s robust APIs and SDKs to integrate staff validation,
              event guest management, and secure access controls into your
              products or workflows—with full flexibility and control.
            </p>
            <a
              href="/auth/account-type"
              className="flex justify-center items-center bg-primary w-44 h-12 rounded-lg text-black text-base font-medium mt-8"
            >
              Get API Key
            </a>
          </div>
      ...
      <section className="container mx-auto mt-20 px-4 xl:px-16">
        <div className="flex flex-col items-center text-center max-w-md mx-auto">
          ...
          <p className="mt-6 text-base text-gray-800 dark:text-gray-300">
            Stay informed about events hosted through SISSL—explore what’s
            coming up or revisit past highlights.
          </p>
        </div>
