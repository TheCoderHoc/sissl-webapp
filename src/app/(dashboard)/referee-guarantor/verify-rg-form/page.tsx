      ...
      <div className="text-white px-6 py-12 mx-auto rounded-xl">
        ...
        >
          <div className="w-[40%] flex flex-col gap-6 px-16">
            <h1 className="text-2xl font-semibold mb-2">Staff Details</h1>
            ...
            <h1 className="text-2xl font-semibold mt-8">Guarantor Details</h1>
            ...
            <div className="flex flex-col gap-4 w-full rounded-lg p-4 opacity-80">
              <label className="font-medium">Guarantor Verification Type</label>
              {[
                { label: "ID Number", value: "ID_NUMBER" },
                {
                  label: "Phone Number",
                ...
                <label key={value} className="flex items-center gap-4">
                  <input
                    ...
                    onChange={(e) => {
                      const current =
                        form.getValues("guarantors.0.verification_method") ||
                        [];
                      const updated = e.target.checked
                        ? [...current, value]
                        : current.filter((item) => item !== value);
